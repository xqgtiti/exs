...
ap.add_argument('-e', '--email', dest='email', help='google username',default="xqgtiti@gmail.com")
ap.add_argument('-p', '--password', dest='password', help='google password',default="zhuzhu66")
...
apps = server.search('com.instagram.android', 1, None)
